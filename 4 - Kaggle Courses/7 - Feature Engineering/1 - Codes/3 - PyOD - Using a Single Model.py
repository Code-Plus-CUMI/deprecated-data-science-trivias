...
clf = { 
    ...
    'K Nearest Neighbors (KNN)': KNN(contamination=out_frac, method='largest', n_neighbors=5),
...
y_train_scores = clf.decision_scores_  # raw outlier scores (distances)
...
outliers_indexes = [
	y_train_pred[index] for index in range(0, len(y_train_pred))
